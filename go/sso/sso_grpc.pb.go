...
type AuthClient interface {
	...
	GetUserByToken(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetUserResponse, error)
}
...
func (c *authClient) GetUserByToken(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
...
type AuthServer interface {
	...
	GetUserByToken(context.Context, *empty.Empty) (*GetUserResponse, error)
...
func (UnimplementedAuthServer) GetUserByToken(context.Context, *empty.Empty) (*GetUserResponse, error) {
...
func _Auth_GetUserByToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).GetUserByToken(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
