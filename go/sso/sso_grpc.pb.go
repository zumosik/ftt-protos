...
func (c *authClient) GetUserByToken(ctx context.Context, in *GetUserByTokenRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
...
func (UnimplementedAuthServer) GetUserByToken(context.Context, *GetUserByTokenRequest) (*GetUserResponse, error) {
